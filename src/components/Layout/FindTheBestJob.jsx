...
const FindTheBestJob = () => {
  return (
    <div className="max-w-7xl mx-auto mb-28 flex items-center justify-between bg-[#2427356b] px-10 py-5  rounded-xl">
      <div className="space-y-6 max-w-2xl">
        ...
        <div className="flex bg-gray-800 p-2 rounded-full shadow-lg w-full max-w-md">
          <input
            type="text"
            placeholder="Search your dream job..."
            className="flex-grow px-4 py-2 bg-transparent text-white placeholder-gray-400 focus:outline-none"
          />
          <button className="px-12 py-7 bg-in bg-gradient-to-br from-primary to-secondary text-white rounded-full btn ">
            Search
          </button>
        </div>
      </div>
